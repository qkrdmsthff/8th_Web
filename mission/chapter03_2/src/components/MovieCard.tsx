...
export default function MovieCard({movie} : MovieCardProps) {
    ...
    return (
        ...
        onMouseLeave={() => setIsHovered(false)}>
            ...
            {isHovered && (
                <div className = 'absolute inset-0 bg-gradiant-to-t from-black/50 t0-transparent backdrop-blur-md flex flex-col justify-center items-center text-white p-4'>
